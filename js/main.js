...
function run(player, host) {
	...
	var World_A1 = new Tileset('/public/game/World_A1.png', 16, 12, WH);
	var World_A2 = new Tileset('/public/game/World_A2.png', 16, 12, WH);
	var World_B = new Tileset('/public/game/World_B.png', 16, 16, WH);
